...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When your application is NOT in debug mode, you can have exception
    | information be emailed to you. Set this option to the receiver
    | email address to activate.
    |
    | Please set 'email.from' and other mailer options before using this
    | feature.
    |
    */

    'email_exceptions' => env('APP_EMAIL_EXCEPTIONS'),
